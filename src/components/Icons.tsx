...
export const RobotIcon = ({ className }: IconProps) => {
  return (
    <svg
      ...
      className={`icon icon-tabler icons-tabler-outline icon-tabler-message-chatbot ${className}`}
    >
...
export const SparklesIcon = ({ className }: IconProps) => {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={`icon icon-tabler icons-tabler-outline icon-tabler-sparkles ${className}`}
    >
      <path stroke="none" d="M0 0h24v24H0z" fill="none" />
